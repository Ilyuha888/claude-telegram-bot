...
┌─────────────────────────────────────────────────────────┐
│                  Hetzner CPX22 VM                        │
│     Ubuntu 24.04 · your-vm-ip (SSH only)                  │
│                                                          │
│  ┌────────────────────────────────────┐                  │
...
└─────────────────────────────────────────────────────────┘
  ...
  @your_telegram_bot        claude.ai/code        SSH /
  (your bot username)       (Remote Control)      emergency
                            secondary access
```
...
| SSH | Admin, emergency | `ssh root@your-vm-ip` |
...
The vault is a **separate Git repository** at `~/repos/ctb-vault` on the VM. It is not part of this repository.
...
- The vault has its own `CLAUDE.md` at `~/repos/ctb-vault/CLAUDE.md`
