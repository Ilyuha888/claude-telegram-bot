...
- **Primary:** Telegram bot (your bot username from `@BotFather`)
- **Secondary:** Remote Control via `claude.ai/code`
- **Admin:** SSH to your VM
...
The runtime lives on the VM. The vault lives in a separate Git repo (`ctb-vault`).
